...
let PA_GET_POLICY   = function(data) {
    let json = _.extend({}, PA_GET_POLICY_JSON);
    _.set(json, 'meta_data.recharge_number', data.recharge_number);
    _.set(json, 'meta_data.amount', data.amount);
    _.set(json, 'meta_data.productId', data.productId);
    _.set(json, 'meta_data.request_id', data.request_id);
    _.set(json, 'product_list.0.id', (_.get(process, 'env.NODE_ENV', 'development').toLowerCase() === 'production') ? 120690906 : 63795764);
    return json;
}
